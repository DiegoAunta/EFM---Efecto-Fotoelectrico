...
[V0M1(1), I0M1(1)] = EFEMetodo1(V1, I1, error/10, 0);
[V0M1(2), I0M1(2)] = EFEMetodo1(V2, I2, error, 0);
[V0M1(3), I0M1(3)] = EFEMetodo1(V3, I3, error/2, 0);
[V0M1(4), I0M1(4)] = EFEMetodo1(V4, I4, error/2, 0);
[V0M1(5), I0M1(5)] = EFEMetodo1(V5, I5, error/2, 0);
...
[V0M2(1)] = EFEMetodo2(V1, I1, 0);
[V0M2(2)] = EFEMetodo2(V2, I2, 0);
[V0M2(3)] = EFEMetodo2(V3, I3, 0);
[V0M2(4)] = EFEMetodo2(V4, I4, 0);
[V0M2(5)] = EFEMetodo2(V5, I5, 0);
...
[V0M3(1)] = EFEMetodo3(V1, I1, 0);
[V0M3(2)] = EFEMetodo3(V2, I2, 0);
[V0M3(3)] = EFEMetodo3(V3, I3, 0);
[V0M3(4)] = EFEMetodo3(V4, I4, 0);
[V0M3(5)] = EFEMetodo3(V5, I5, 0);
...
fid = fopen('Intensidad2_Metodo1.txt', 'w');
...
%Exportar resultados
% Abrir el archivo para escribir
fid = fopen('Intensidad2_Metodo2.txt', 'w');
...
%Exportar resultados
% Abrir el archivo para escribir
fid = fopen('Intensidad2_Metodo3.txt', 'w');
